-- ═══════════════════════════════════════════════════════════════════════════
-- ETAPA 3: RPC registrar_cobro_por_componentes
-- GestorAlquileres · Proyecto: axsrpvsacxpqhxecxydm
-- Creada: 2026-06-20
-- IMPORTANTE: NO conectar al frontend hasta Etapa 4.
-- Esta RPC convive con registrar_cobro_operativo_v4_multipago sin reemplazarla.
-- ═══════════════════════════════════════════════════════════════════════════
...
-- ─── PASO 4: Validar cada aplicación contra cuotas_operativas ────────────
  ...
  FOR v_idx IN 0..v_n_apps-1 LOOP
    ...
    -- Requiere que la cuota tenga datos de componentes (Etapa 2B)
    ...
    -- Impuesto: solo si monto_impuesto_total fue cargado por el jefe
    ...
    -- Servicio: solo contratos con servicios_habilitados
...
-- ─── PASO 6: Período primario y texto visual ──────────────────────────────
  ...
  -- Texto visual (NO fuente de verdad; solo para campos descriptivos)
